          ...
          <nav className="hidden lg:flex items-center space-x-8 h-full">
            {navItems.map((item, index) => (
              ...
              >
                ...
                {/* Content */}
                <div className="relative text-gray-700 group-hover:text-primary-dark transition-colors duration-300 font-medium" style={{ textShadow: '0.5px 0.5px 0 white, -0.5px -0.5px 0 white, 0.5px -0.5px 0 white, -0.5px 0.5px 0 white' }}>
                  {item.label}
                </div>
